	...
	<div class="speak_box">
		<div class="answer">
			...
			<div class="answer_text">
				<p>Hey，你好，校美好专属客服，小塔姆在此，你有什么疑问或者建议可以语音和文字给我反馈。如果你时间紧张可以给我们发送邮件，邮箱地址：799873165@qq.com。我们会虚心采纳的。</p>
				<i></i>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function up_say(){
	    ...
	    var text = $('.write_box input').val(),
	        ...
	        str += '<div class="heard_img right"><img src="images/touxian.jpg"/></div>';
