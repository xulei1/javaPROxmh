...
<head>
  ...
  <title>物品界面</title>
	...
	<script type="text/javascript">
  	...
  	<style type="text/css">
    div.container {background-image: url(images-shop/notebook.jpg);
    ...
    <div class="popup" id="popup">
      <div class="popup-inner">
        <div class="popup__photo">
          <img src="${ctx }/images-shop/notebook3.jpg" alt="">
        </div>
          ...
          <section>
            <div class="holder col-4">
            	<c:if test="${lu.score>=100}">
              		<div class="deo"><a href="${ctx }/makeOrder.jsp?userid=${lu.id}&goodsid=001"><button class="rkmd-btn btn-orange ripple-effect"><i class="material-icons"></i>立即兑换</button></a></div>
              	</c:if>
              	<c:if test="${lu.score<100}">
              		<div class="deo">
