...
<body>
	<div class="main">
		<div class="nav">
		<div class="font t_c">校</div>
		<div class="font t_r">美</div>
		<div class="font t_e">好</div>
		<div class="font t_a">后</div>
		<div class="font t_t">台</div>
		<div class="font t_d">登</div>
		<div class="font t_m">陆</div>
			<div class="nav_left">
			...
			<div class="nav_right">
				<ul>
					...
					<li><a href="#">大学商城</a></li>
					<li><a href="#">联系我们</a></li>
					<li style="width:150px"><a href="#">English</a> | <a href="#">繁体汉语</a></li>
				</ul>
			</div>
		</div>
		<div class="middle">
		...
		<div class="footer">
			CREATE DREAM@校美好</br>
			© 2018 Pactera. All rights reserved. Liaoning ICP 11007858-3. Jing Gongwang Anbei 11010802016198
		</div>
	</div>
</body>
</html>
